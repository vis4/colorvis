...
(function() {
  ...
  */
  ...
  Color.lab2xyz = function(l, a, b) {
    ...
    */
    var finv, ill, sl, x, y, z, _ref7;
    if (l !== void 0 && l.length === 3) {
      _ref7 = l, l = _ref7[0], a = _ref7[1], b = _ref7[2];
    }
    finv = function(t) {
      if (t > (6.0 / 29.0)) {
        return t * t * t;
  ...
  Color.xyz2rgb = function(x, y, z) {
    ...
    */
    var b, bl, clip, correct, g, gl, r, rl, _ref7, _ref8;
    ...
    if (clip) {
      _ref8 = [void 0, void 0, void 0], rl = _ref8[0], gl = _ref8[1], bl = _ref8[2];
    }
    correct = function(cl) {
      var a;
      a = 0.055;
  ...
  Color.lab2rgb = function(l, a, b) {
    ...
    */
    var x, y, z, _ref7, _ref8, _ref9;
    if (l !== void 0 && l.length === 3) {
      _ref7 = l, l = _ref7[0], a = _ref7[1], b = _ref7[2];
    }
    if (l !== void 0 && l.length === 3) {
      _ref8 = l, l = _ref8[0], a = _ref8[1], b = _ref8[2];
    }
    _ref9 = Color.lab2xyz(l, a, b), x = _ref9[0], y = _ref9[1], z = _ref9[2];
    return Color.xyz2rgb(x, y, z);
  };

  Color.cls2rgb = function(c, l, s) {
    var L, TAU, a, angle, b, r, _ref7;
    if (s == null) s = 1;
    if (c !== void 0 && c.length === 3) {
      _ref7 = c, c = _ref7[0], l = _ref7[1], s = _ref7[2];
    }
  ...
  Color.rgb2xyz = function(r, g, b) {
    var bl, correct, gl, rl, x, y, z, _ref7;
    if (r !== void 0 && r.length === 3) {
      _ref7 = r, r = _ref7[0], g = _ref7[1], b = _ref7[2];
    }
    correct = function(c) {
  ...
  Color.rgb2lab = function(r, g, b) {
    var x, y, z, _ref7, _ref8;
    if (r !== void 0 && r.length === 3) {
      _ref7 = r, r = _ref7[0], g = _ref7[1], b = _ref7[2];
    }
    _ref8 = Color.rgb2xyz(r, g, b), x = _ref8[0], y = _ref8[1], z = _ref8[2];
